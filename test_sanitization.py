...
def test_text_sanitization():
    ...
    for input_text, expected in test_cases:
        ...
        if expected in result and not any(char in result for char in ['*', '_', '`', '#', '[', ']', '•', '<script', 'onclick']):
